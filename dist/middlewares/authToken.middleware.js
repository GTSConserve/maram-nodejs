...
exports.nonMandatoryToken = exports.authenticateJWTSession = exports.authenticateJWT = void 0;
...
var nonMandatoryToken = function nonMandatoryToken(req, res, next) {
  res.locals.optionalToken = true;
  next();
};
exports.nonMandatoryToken = nonMandatoryToken;
var authenticateJWTSession = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var token, currentTokenPayload, is_super_admin;
  ...
  return function authenticateJWTSession(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
exports.authenticateJWTSession = authenticateJWTSession;
var authenticateJWT = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res, next) {
    var _res$locals$optionalT;
    var optionalToken, token, currentTokenPayload, checkUser, _yield$getUserToken, status, refreshToken, languageId, tokens;
