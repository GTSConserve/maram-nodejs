...
var _dummy_data = require("../seeds/dummy_data");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            // get random id
            get_random_id = function get_random_id(arr) {
              return arr[Math.floor(Math.random() * arr.length)].id;
            }; // weekdays
            _context.next = 4;
            return (0, _db["default"])("weekdays").insert(_dummy_data.week_days);
          case 4:
            _context.next = 6;
            return (0, _db["default"])("banners").insert(_dummy_data.banners);
          case 6:
            _context.next = 8;
            return (0, _db["default"])("user_groups").insert(_dummy_data.user_groups);
          case 8:
            _context.next = 10;
            return _bcrypt["default"].hash("admin2022", 10);
          case 10:
