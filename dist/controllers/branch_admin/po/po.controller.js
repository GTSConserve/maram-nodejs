...
var getAddOnExcessProductPO = /*#__PURE__*/function () {
  ...
  return function getAddOnExcessProductPO(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
exports.getAddOnExcessProductPO = getAddOnExcessProductPO;
var getPoForm = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var admin_id, tommorow_date, today_date, check_already_po_generated, branch_details, daily_orders, _yield$getBothProduct, add_on_products, subscription_products, excess_add_on_products;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            check_already_po_generated = _context2.sent;
          ...
          case 19:
            ...
            excess_add_on_products = _yield$getBothProduct.excess_add_on_products;
...
var createPoForm = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body, admin_id, sub_products, add_on_products, today_date, po_id, add_on_total, sub_total, i, _i;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 17:
            ...
            _i = 0;
          case 19:
            if (!(_i < sub_products.length)) {
              _context3.next = 26;
              break;
            }
            sub_total = sub_total + Number(sub_products[_i].total_price);
            _context3.next = 23;
            return (0, _db["default"])("branch_purchase_order_items").insert({
              branch_purchase_order_id: po_id[0],
              branch_id: admin_id,
              product_id: sub_products[_i].product_id,
              price: sub_products[_i].price,
              qty: sub_products[_i].qty,
              excess_qty: sub_products[_i].excess_qty ? sub_products[_i].excess_qty : 0,
              total_qty: sub_products[_i].total_qty,
              unit_value: sub_products[_i].value,
              total_price: sub_products[_i].total_price,
              product_type_id: 1
            });
          case 23:
            _i++;
  ...
  return function createPoForm(_x5, _x6) {
...
var getApprovePO = /*#__PURE__*/function () {
  ...
  return function getApprovePO(_x9, _x10) {
