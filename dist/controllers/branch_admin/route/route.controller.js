...
exports.updateRouteStatus = exports.updateRoute = exports.getViewMapping = exports.getUserMapping = exports.getRoute = exports.createRoute = void 0;
...
var getViewMapping = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var admin_id, loading, _req$query, searchKeyword, route_id, data_length, users, results, data;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            return _context.abrupt("return", res.redirect("/branch_admin/route/user_mapping"));
          case 13:
            _context.next = 15;
            return _db["default"].raw("SELECT users.name as user_name, sub.id,user_address.address,user_address.landmark, users.user_unique_id FROM subscribed_user_details as sub \n        JOIN users ON users.id = sub.user_id\n        JOIN user_address ON user_address.id = sub.user_address_id\n        WHERE sub.router_id = ".concat(route_id, " AND sub.subscription_status =  \"subscribed\"  "));
          case 15:
  ...
  return function getViewMapping(_x, _x2) {
...
var getUserMapping = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var admin_id, loading, _req$query2, searchKeyword, route_id, data_length, search_data_length, _yield$getPageNumber, startingLimit, page, resultsPerPage, numberOfPages, iterator, endingLink, results, is_search, data, i;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 8;
            return _db["default"].raw("SELECT sub.id FROM subscribed_user_details as sub\n        JOIN users ON users.id = sub.user_id\n        WHERE sub.router_id = ".concat(route_id, " AND sub.subscription_status = \"subscribed\" AND users.user_unique_id LIKE '%").concat(searchKeyword, "%'"));
          case 8:
            ...
            req.flash("error", "No User Found");
            return _context2.abrupt("return", res.redirect("/branch_admin/route/user_mapping"));
          case 15:
            _context2.next = 20;
            break;
          case 17:
          ...
          case 20:
            ...
            loading = false;
            return _context2.abrupt("return", res.render("branch_admin/route/user_mapping", {
              data: data_length,
          ...
          case 23:
            _context2.next = 25;
            return (0, _helper.getPageNumber)(req, res, data_length, "route/user_mapping");
          case 25:
          ...
          case 40:
            _context2.next = 42;
            return _db["default"].raw("SELECT sub.id,users.name as user_name,user_address.address,user_address.landmark, users.user_unique_id,users.mobile_number,products.name as product_name,products.unit_value,products.price,sub.quantity,unit_types.value,sub.subscription_start_date,sub.customized_days,subscription_type.name as sub_name FROM subscribed_user_details as sub \n        JOIN users ON users.id = sub.user_id\n        JOIN products on products.id = sub.product_id\n        JOIN unit_types ON unit_types.id = products.unit_type_id\n        JOIN user_address ON user_address.id = sub.user_address_id\n        JOIN subscription_type ON subscription_type.id = sub.subscribe_type_id\n        WHERE sub.router_id = ".concat(route_id, " AND sub.subscription_status =  \"subscribed\"  LIMIT ").concat(startingLimit, ",").concat(resultsPerPage));
          case 42:
            results = _context2.sent;
          case 43:
            data = results[0];
  ...
  return function getUserMapping(_x3, _x4) {
...
var updateRoute = /*#__PURE__*/function () {
  ...
  return function updateRoute(_x5, _x6) {
...
var updateRouteStatus = /*#__PURE__*/function () {
  ...
  return function updateRouteStatus(_x7, _x8) {
...
var createRoute = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            req.flash("error", "Route Name is missing");
            return _context5.abrupt("return", res.redirect("/branch_admin/route/get_route"));
          case 5:
            // if (!city_id) {
  ...
  return function createRoute(_x9, _x10) {
...
var getRoute = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var admin_id, loading, searchKeyword, data_length, search_data_length, cities, is_rider, riders, _yield$getPageNumber2, startingLimit, page, resultsPerPage, numberOfPages, iterator, endingLink, results, is_search, data;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 8:
            search_data_length = _context6.sent;
            data_length = search_data_length[0];
            if (!(data_length.length === 0)) {
              _context6.next = 15;
              break;
          ...
          case 27:
            riders = _context6.sent;
            if (!(data_length.length === 0)) {
              _context6.next = 31;
              break;
            }
            loading = false;
            return _context6.abrupt("return", res.render("branch_admin/route/get_route", {
              data: data_length,
              searchKeyword: searchKeyword,
              cities: cities,
              riders: riders
          ...
          case 33:
            _yield$getPageNumber2 = _context6.sent;
  ...
  return function getRoute(_x11, _x12) {
