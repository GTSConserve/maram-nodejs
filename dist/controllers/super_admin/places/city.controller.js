...
exports.updateCityStatus = exports.updateCity = exports.getCities = exports.createCity = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return _db["default"].raw("SELECT id,name FROM cities WHERE name LIKE '%".concat(searchKeyword, "%'"));
          case 7:
            ...
            return _context.abrupt("return", res.redirect("/super_admin/places/city"));
          case 14:
            _context.next = 19;
            break;
          case 16:
            _context.next = 18;
            return (0, _db["default"])("cities").select("id");
          case 18:
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            req.flash("error", "Name is missing");
            return _context3.abrupt("return", res.redirect("/super_admin/places/city"));
          case 5:
            query = {};
            query.name = name;
            if (latitude) {
...
var updateCityStatus = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            _context4.next = 5;
            return (0, _db["default"])("cities").update({
              status: "0"
            }).where({
              id: id
            });
          ...
          case 9:
            req.flash("success", "Updated SuccessFully");
            return _context4.abrupt("return", res.redirect("/super_admin/places/city"));
          case 13:
            _context4.prev = 13;
  ...
  return function updateCityStatus(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
exports.updateCityStatus = updateCityStatus;