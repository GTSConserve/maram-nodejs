...
exports.updeteRiderLocation = exports.updateStartTour = exports.updateRiderstatus = exports.updateEndtour = exports.ten = exports.login = exports.getRiderdetails = void 0;
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var payload, user_name, password, checkPhoneNumber, checkPassword, query, userId, users, users_length;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("hi");
            _context.next = 8;
            return (0, _rider.userLogin)(password);
          case 8:
            checkPhoneNumber = _context.sent;
            _context.next = 11;
            return _db["default"].select("id").from("rider_details").where({
              password: password
            });
          case 11:
          ...
          case 20:
            ...
            console.error('Whooops! This broke with error: ', _context.t0);
...
var getRiderdetails = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var delivary_partner_id, delivary_partner;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            delivary_partner_id = req.body.delivary_partner_id;
            ...
            return _context2.abrupt("return", res.status(_responseCode["default"].FAILURE.BAD_REQUEST).json({
              status: false,
              message: "delivary_partner_id Is Missing"
            }));
          case 4:
            _context2.next = 6;
            return (0, _rider.get_riderdetails)(delivary_partner_id);
          case 6:
            delivary_partner = _context2.sent;
            return _context2.abrupt("return", res.status(_responseCode["default"].SUCCESS).json({
              data: delivary_partner.body,
              status: true,
              message: "ok"
            }));
          case 10:
  ...
  return function getRiderdetails(_x3, _x4) {
...
var updateRiderstatus = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 6:
            riderstatus = _context3.sent;
            if (!riderstatus.status) {
              _context3.next = 11;
              break;
            }
            return _context3.abrupt("return", res.status(_responseCode["default"].SUCCESS).json(riderstatus));
          case 11:
            return _context3.abrupt("return", res.status(_responseCode["default"].FAILURE.DATA_NOT_FOUND).json(riderstatus));
          case 12:
            _context3.next = 18;
            break;
          case 14:
  ...
  return function updateRiderstatus(_x5, _x6) {
...
var updeteRiderLocation = /*#__PURE__*/function () {
  ...
  return function updeteRiderLocation(_x7, _x8) {
...
var updateStartTour = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 6:
            starttour = _context5.sent;
            if (!starttour.status) {
              _context5.next = 11;
              break;
            }
            return _context5.abrupt("return", res.status(_responseCode["default"].SUCCESS).json(starttour));
          case 11:
            return _context5.abrupt("return", res.status(_responseCode["default"].FAILURE.DATA_NOT_FOUND).json(starttour));
          case 12:
            _context5.next = 18;
            break;
          case 14:
  ...
  return function updateStartTour(_x9, _x10) {
...
var updateEndtour = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 6:
            endtour = _context6.sent;
            if (!endtour.status) {
              _context6.next = 11;
              break;
            }
            return _context6.abrupt("return", res.status(_responseCode["default"].SUCCESS).json(endtour));
          case 11:
            return _context6.abrupt("return", res.status(_responseCode["default"].FAILURE.DATA_NOT_FOUND).json(endtour));
          case 12:
            _context6.next = 18;
            break;
          case 14:
  ...
  return function updateEndtour(_x11, _x12) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 6:
            checkPhoneNumber = _context7.sent;
            userId = 0; // const otp = process.env.USER_OTP || Math.floor(1000 + Math.random() * 9000)
            // const otp = '1234'
