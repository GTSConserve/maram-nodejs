...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _payload, user_name, password, checkPhoneNumber, query, userId, today;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _payload = payload, user_name = _payload.user_name, password = _payload.password;
            if (!payload) {
              _context.next = 15;
              break;
            }
            _context.next = 5;
            return (0, _user.loginUser)(password);
          case 5:
            ...
            _context.next = 11;
            return (0, _user.insertRider)(payload);
          case 11:
            query = _context.sent;
          case 12:
            // else {
          ...
          case 18:
            ...
            logger.error('Whooops! This broke with error: ', _context.t0);
