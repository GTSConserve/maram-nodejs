...
exports.userAddressChange = exports.updateUser = exports.getUser = exports.getSingleCalendarEvent = exports.getSingleCalendar = exports.getSingleBillList = exports.getOverallCalendarEvent = exports.getOverallCalendar = exports.getEmptyBottle = exports.getBillList = exports.getAddress = exports.editAddress = exports.deleteUseraddress = exports.checkDeliveryAddress = exports.changePlan = exports.addUserAddress = exports.RiderLocation = exports.RemoveOrder = exports.Edit = void 0;
...
var getSingleCalendar = /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(req, res) {
    var date, _single_calendar_data;
...
var getSingleCalendarEvent = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context17.prev = _context17.next) {
          case 0:
            ...
            return _context17.abrupt("return", res.status(_responseCode["default"].FAILURE.BAD_REQUEST).json({
              status: false,
              message: _messages["default"].MANDATORY_ERROR
            }));
          case 4:
          ...
          case 6:
            ...
            return _context17.abrupt("return", res.status(_responseCode["default"].FAILURE.DATA_NOT_FOUND).json({
              status: false,
              message: sub.message
            }));
          case 9:
  ...
  return function getSingleCalendarEvent(_x33, _x34) {
...
var getOverallCalendarEvent = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context18.prev = _context18.next) {
          case 0:
            ...
            return _context18.abrupt("return", res.status(_responseCode["default"].FAILURE.BAD_REQUEST).json({
              status: false,
              message: _messages["default"].MANDATORY_ERROR
            }));
          case 4:
  ...
  return function getOverallCalendarEvent(_x35, _x36) {
...
var RiderLocation = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context19.prev = _context19.next) {
          ...
          case 4:
            ...
            return _context19.abrupt("return", res.status(_responseCode["default"].SUCCESS).json({
              status: true,
              data: {
                user: user,
                branch: branch,
  ...
  return function RiderLocation(_x37, _x38) {
