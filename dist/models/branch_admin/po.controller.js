...
exports.getBothProducts = void 0;
...
var getBothProducts = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _context.next = 7;
            return (0, _db["default"])("subscribed_user_details").select("product_id", "quantity").where({
              id: daily_orders[i].subscription_id
            });
          case 7:
          ...
          case 9:
            ...
            _context.next = 12;
            return (0, _db["default"])("add_on_order_items").select("product_id", "quantity").where({
              add_on_order_id: daily_orders[i].add_on_order_id
            });
          case 12:
            add_product_id = _context.sent;
          ...
          case 44:
            ...
            for (_i6 = 0; _i6 < subscription_products.length; _i6++) {
              if (subscription_products[_i6].unit_type == "ml") {
                if (subscription_products[_i6].unit_value >= 500) {
                  subscription_products[_i6].value = subscription_products[_i6].unit_value / 1000 + " litre";
                } else {
                  subscription_products[_i6].value = subscription_products[_i6].unit_value + " litre";
                }
              } else {
                subscription_products[_i6].value = subscription_products[_i6].unit_value + " " + subscription_products[_i6].unit_type;
              }
            }
            for (_i7 = 0; _i7 < add_on_products.length; _i7++) {
              if (add_on_products[_i7].unit_type == "ml") {
                if (add_on_products[_i7].unit_value >= 500) {
                  add_on_products[_i7].value = add_on_products[_i7].unit_value / 1000 + " litre";
                } else {
                  add_on_products[_i7].value = add_on_products[_i7].unit_value + " litre";
                }
              } else {
  ...
  return function getBothProducts(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.getBothProducts = getBothProducts;