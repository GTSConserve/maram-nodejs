...
exports.getPassword = exports.checkUser = void 0;
...
var getPassword = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _db["default"])("admin_users").select('email', 'password');
          case 3:
            change_password = _context2.sent;
  ...
  return function getPassword(_x3, _x4) {
