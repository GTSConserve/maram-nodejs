...
exports.single_subscription = exports.remove_subscription = exports.new_subscription = exports.get_subscription_product = exports.get_subcription_order = exports.change_subscriptionplan = exports.change_quantity = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _db["default"])("subscribed_user_details AS sub").select("sub.id as subscription_id", "products.name as product_name", "products.image", "products.unit_value", "unit_types.value as unit_type", "subscription_type.name as subscription_name").join("products", "products.id", "=", "sub.product_id").join("unit_types", "unit_types.id", "=", "products.unit_type_id").join("subscription_type", "subscription_type.id", "=", "sub.subscribe_type_id").where({
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 19:
            ...
            return (0, _db["default"])("subscribed_user_details").update({
              start_date: start_date,
              subscribe_type_id: subscription_plan_id,
              customized_days: store_weekdays
            }).where({
              user_id: userId,
              id: subscription_id
            });
