      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return (0, _db["default"])("subscribed_user_details AS sub").select("sub.id as subscription_id", "sub.date", "products.name as product_name", "products.image", "products.price", "products.unit_value", "unit_types.value as unit_type", "subscription_type.name as subscription_name", "sub.subscription_status", "sub.quantity", "sub.date").join("products", "products.id", "=", "sub.product_id").join("unit_types", "unit_types.id", "=", "products.unit_type_id").join("subscription_type", "subscription_type.id", "=", "sub.subscribe_type_id").orderBy('subscription_id', 'desc').where({
              "sub.user_id": userId
            });
          case 4:
...
var change_subscriptionplan = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(userId, subscription_id, subscription_plan_id, start_date, customized_days) {
    var query, _subscription_status, previous, weekdays, store_weekdays, i, j;
