...
var get_subscription_product = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId) {
    var _knex$select$join$joi, products;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _db["default"])("subscribed_user_details AS sub").select("sub.id as subscription_id", "products.name as product_name", "products.image", "products.unit_value", "unit_types.value as unit_type", "subscription_type.name as subscription_name", "sub.subscription_status", "sub.quantity").join("products", "products.id", "=", "sub.product_id").join("unit_types", "unit_types.id", "=", "products.unit_type_id").join("subscription_type", "subscription_type.id", "=", "sub.subscribe_type_id").where((_knex$select$join$joi = {
              "sub.subscription_status": "subscribed"
            }, _defineProperty(_knex$select$join$joi, "sub.subscription_status", "pending"), _defineProperty(_knex$select$join$joi, "user_id", userId), _knex$select$join$joi));
          case 3:
